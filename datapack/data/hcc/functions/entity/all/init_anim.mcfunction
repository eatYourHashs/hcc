...
execute store result entity @s[type=!item_display,type=!fox] ArmorItems[3].tag.CustomPotionColor int 1 run scoreboard players get $temp.time hcc.dummy
execute store result entity @s[type=fox] HandItems[0].tag.CustomPotionColor int 1 run scoreboard players get $temp.time hcc.dummy
