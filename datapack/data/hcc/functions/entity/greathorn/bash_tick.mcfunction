...
execute if score @s hcc.dummy matches 28..31 positioned ^ ^-0.5 ^0.5 as @a[distance=..3,gamemode=!spectator] run damage @s 10 minecraft:mob_attack by @e[type=ravager,tag=hcc.greathorn_hitbox,limit=1,sort=nearest]
...
execute if score @s hcc.dummy matches 32..35 positioned ^ ^1.5 ^3.5 as @a[distance=..3,gamemode=!spectator] run damage @s 10 minecraft:mob_attack by @e[type=ravager,tag=hcc.greathorn_hitbox,limit=1,sort=nearest]