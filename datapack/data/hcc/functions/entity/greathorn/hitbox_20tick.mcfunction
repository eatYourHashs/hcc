...
execute unless score @s hcc.target_uuid1 matches 1.. unless score @s hcc.target_uuid1 matches ..-1 if entity @a[distance=..24,gamemode=!spectator,gamemode=!creative] positioned ~ ~3 ~ facing entity @r[distance=..24,gamemode=!spectator,gamemode=!creative] feet run function hcc:entity/greathorn/attempt_target
