...
execute if score @s hcc.target_uuid1 matches 0.. at @e[type=!#hcc:never_targetted] if score @s hcc.target_uuid1 = @e[type=!#hcc:never_targetted,sort=nearest,limit=1] hcc.uuid1 run tag @e[type=!#hcc:never_targetted,sort=nearest,limit=1] add hcc.attack_target
...
execute if score @s hcc.dummy matches 1..150 if entity @s[tag=hcc.diving] facing entity @e[type=!#hcc:never_targetted,tag=hcc.attack_target,limit=1,sort=nearest] feet run tp @s ~ ~ ~ ~ ~
